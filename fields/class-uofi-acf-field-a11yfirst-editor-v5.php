...
if( ! class_exists('acf_field_a11yfirst_editor') ) :

class acf_field_a11yfirst_editor extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'a11yfirst_editor';
		$this->label = __("a11yfirst_editor",'acf');
	...
	*  get_toolbars
	*
	*  This function will return an array of toolbars for the a11yfirst_editor field
	*
	*  @type	function
	*  @date	18/04/2014
	*  @since	1.0.0
	...
	*/
   	...
   	function get_toolbars() {
		...
		// Full
   		...
   		$toolbars = apply_filters( 'acf/fields/a11yfirst_editor/toolbars', $toolbars );
...
<?php
	...
	*/
	...
	function render_field( $field ) {
		...
		// get height
		$height = acf_get_user_setting('a11yfirst_editor_height', 300);
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('A11yFirst editor will not be initalized until field is clicked','acf'),
			'name'			=> 'delay',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
...
// initialize
acf_register_field_type( 'acf_field_a11yfirst_editor' );
